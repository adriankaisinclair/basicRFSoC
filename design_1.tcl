...
adriankaisinclair:user:cordic2:1.0\
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_JITTER {108.370} \
   CONFIG.CLKOUT1_PHASE_ERROR {123.429} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {256.000} \
   CONFIG.MMCM_CLKFBOUT_MULT_F {18.500} \
  ...
  # Create instance: cordic2_0, and set properties
  set cordic2_0 [ create_bd_cell -type ip -vlnv adriankaisinclair:user:cordic2:1.0 cordic2_0 ]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins cordic2_0/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins ps8_0_axi_periph/M03_AXI] [get_bd_intf_pins tlast_gen_0/S00_AXI]
  connect_bd_intf_net -intf_net sysref_in_1 [get_bd_intf_ports sysref_in] [get_bd_intf_pins usp_rf_data_converter_0/sysref_in]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m00_axis [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins usp_rf_data_converter_0/m00_axis]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins cordic2_0/dac_clk_in] [get_bd_pins tlast_gen_0/dac_clk_in] [get_bd_pins usp_rf_data_converter_0/m0_axis_aclk] [get_bd_pins usp_rf_data_converter_0/s1_axis_aclk]
  connect_bd_net -net cordic2_0_I0toDAC [get_bd_pins cordic2_0/I0toDAC] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net cordic2_0_I1toDAC [get_bd_pins cordic2_0/I1toDAC] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn]
  connect_bd_net -net tlast_gen_0_pulse_out [get_bd_pins axi_dma_0/s_axis_s2mm_tlast] [get_bd_pins tlast_gen_0/pulse_out]
  connect_bd_net -net usp_rf_data_converter_0_clk_dac1 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins usp_rf_data_converter_0/clk_dac1]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins usp_rf_data_converter_0/s12_axis_tdata] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk1] [get_bd_pins cordic2_0/s00_axi_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins tlast_gen_0/s00_axi_aclk] [get_bd_pins usp_rf_data_converter_0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins cordic2_0/s00_axi_aresetn] [get_bd_pins rst_ps8_0_99M/ext_reset_in] [get_bd_pins tlast_gen_0/s00_axi_aresetn] [get_bd_pins usp_rf_data_converter_0/m0_axis_aresetn] [get_bd_pins usp_rf_data_converter_0/s1_axis_aresetn] [get_bd_pins usp_rf_data_converter_0/s_axi_aresetn] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xA0040000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs cordic2_0/S00_AXI/S00_AXI_reg] SEG_cordic2_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00001000 -offset 0xA0042000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs tlast_gen_0/S00_AXI/S00_AXI_reg] SEG_tlast_gen_0_S00_AXI_reg
